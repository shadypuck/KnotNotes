        ...
        \begin{tikzpicture}
            ...
            \begin{scope}[xshift=2cm,scale=-1]
                \begin{knot}[
                    ...
                    ;
                \end{knot}
                \node [draw=red,circle,thick,scale=-1] at (-0.3,0) [top color=ory,bottom color=orz] {$T$};
            \end{scope}
        \end{tikzpicture}
        \caption{A flype.}
        \label{fig:flype}
...
\begin{itemize}
    \item The Alexander polynomial $\Delta$ was invented in 1928 and was the first polynomial to be invented.
