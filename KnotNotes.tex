...
\begin{itemize}
    ...
    \end{itemize}
    \item There is also a biological assumption that can help: \dq{The tangles $T$ and $T$ do not depend on the tangle $S$}{193}
    \begin{itemize}
        ...
        \begin{tikzpicture}[scale=0.9]
            ...
            \begin{scope}[xshift=-2cm]
                ...
                \begin{knot}[
                    ...
                    \strand [red,ultra thick] (b) to [out=-110,in=110,distance=2cm] (e);
                \end{knot}
            \end{scope}
            \draw [very thick,-latex] (-0.4,0) -- (0.4,0);
            \begin{scope}[xshift=2cm]
            ...
            \begin{scope}[xshift=7.5cm]
                ...
                \draw [red,ultra thick] ([xshift=-1.52cm,yshift=0.55cm]knot 4)
                    arc (220:250:2cm and 0.7cm)
                    to [out=-5,in=180,looseness=1.2] (0,-0.7)
                    arc (-70:-40:2cm and 0.7cm)
                ;
                \draw [white,ultra thick,double=red,double distance=1.6pt] ([xshift=-1.52cm,yshift=-0.15cm]knot 4)
                    arc (220:250:2cm and 0.7cm)
                    to [out=-5,in=180,looseness=1.2] (0,0)
                    arc (-70:-40:2cm and 0.7cm)
                ;
