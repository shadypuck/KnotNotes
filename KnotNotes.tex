...
\begin{itemize}
    ...
    \end{itemize}
    \item In this section, results known for alternating knots (many are listed in Section \ref{sss:polynomials}) will be generalized to almost alternating knots.
