...
\begin{itemize}
    ...
    \item Any time we have a composite knot, there exist an incompressible \textbf{swallow-follow torus}.
...
\begin{itemize}
    ...
    \begin{figure}[h!]
        ...
        \label{fig:mobius}
    \end{figure}
    \item \textbf{M\"{o}bius band}: One of the simplest surfaces that is not orientable.
