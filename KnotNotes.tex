...
\begin{itemize}
    ...
    \item For example, the leftmost and rightmost surfaces in Figure \ref{fig:homeo} are both homromorphic with a torus.
    \begin{itemize}
    ...
    \item Since we could keep increasing the number of wholes, there are infinitely many distinct (nonhomeomorphic) surfaces.
