...
\begin{itemize}
    ...
    \end{equation}
    \item \emph{Exercise 3.4}: Show that a knot like the one in Figure \ref{fig:ex3-4} is alternating by finding an alternating projection. Then show that it has unknotting number 1 by showing that there is a crossing in this projection that can be changed to yield the trivial knot.
    \begin{figure}[h!]
        \centering
        \includegraphics[width=0.6\linewidth]{Blender/ex3-4.png}
        \caption{Knot to alternate and later unknot.}
        \label{fig:ex3-4}
    \end{figure}
    \begin{figure}[h!]
        \centering
        \rule{0.8\linewidth}{2cm}
        \caption{Solution to \emph{Exercise 3.4}.}
        \label{fig:ex3-4-2}
    \end{figure}
\end{itemize}
