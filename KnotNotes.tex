...
\begin{itemize}
    ...
    \end{itemize}
    \item On the other hand, a Type I Reidemeister move always changes the writher by $\pm 1$.
    ...
    \end{itemize}
    \item \emph{Exercise 6.8}: Use the skein relation of the bracket polynomial in order to show that the Jones polynomial of the three links in Figure \ref{fig:ex6-8} are related through the following equation.
    ...
    \begin{itemize}
        ...
        \item The substitutions come from Rule 2 and the fact that $A=t^{-\frac{1}{4}}$.
    \end{itemize}
    \begin{align*}
