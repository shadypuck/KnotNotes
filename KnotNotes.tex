...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item Dots, when present, represent bounds on the overpasses (and, technically, the underpasses).
        ...
        \end{itemize}
        \item Three times sequentially, employ two Type II Reidemeister moves followed by one Type III Reidemeister moves to (for the first two) shift the position of the 1-crossing overpass and then (for the last one) eliminate the 1-crossing overpass. These moves occur on the orange, purple, and green strands, sequentially. They yield a projection with bridge number 2 (Figure \ref{fig:ex3-11-2e}).
        \item Q.E.D.
